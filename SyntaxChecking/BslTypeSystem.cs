namespace CodeDictionary.SyntaxChecking
{
    ...
    {
        public static Dictionary<string, BslTypeInfo> KnownTypes = new()
        {
        ...
        public static void ImportFromJson(List<JsonTypeDefinition> types)
        {
            KnownTypes.Clear();
            foreach (var type in types)
            {
                var info = new BslTypeInfo { Name = type.Name };
                ...
                if (type.Methods != null)
                {
                    foreach (var method in type.Methods)
                    {
                        ...
                        var paramDefs = sig?.Params ?? method.Params;

                        info.Members[method.Name] = new BslMemberInfo
                        {
                            Name = method.Name,
                            ParameterNames = paramDefs?.Select(p => p.Name).ToArray() ?? [],
                            ParameterTypes = paramDefs?.Select(p => p.Type ?? "").ToArray() ?? [],
                            ReturnType = method.Return ?? method.ReturnTypeDefinition?.Name ?? "",
                            IsFunction = !string.IsNullOrEmpty(method.Return) || method.ReturnTypeDefinition != null
                        };
                    }
                }
                ...
                if (type.Properties != null)
                {
                    ...
                    {
                        info.Members[prop.Name] = new BslMemberInfo
                        {
                            Name = prop.Name,
        ...
        {
            KnownTypes.Clear();
            KnownTypes["Структура"] = new BslTypeInfo
            {
                Name = "Структура",
                Members = new()
                {
            ...
            KnownTypes["Массив"] = new BslTypeInfo
            {
                Name = "Массив",
                Members = new()
                {
            ...
            KnownTypes["СписокЗначений"] = new BslTypeInfo
            {
                Name = "СписокЗначений",
                Members = new()
                {
            ...
            KnownTypes["ТаблицаЗначений"] = new BslTypeInfo
            {
                Name = "ТаблицаЗначений",
                Members = new()
                {
            ...
            KnownTypes["Соответствие"] = new BslTypeInfo
            {
                Name = "Соответствие",
                Members = new()
                {
            ...
            KnownTypes["ЧтениеТекста"] = new BslTypeInfo
            {
                Name = "ЧтениеТекста",
                Members = new()
                {
            ...
            KnownTypes["ЗаписьТекста"] = new BslTypeInfo
            {
                Name = "ЗаписьТекста",
                Members = new()
                {
            ...
            KnownTypes["ЧтениеXML"] = new BslTypeInfo
            {
                Name = "ЧтениеXML",
                Members = new()
                {
            ...
            KnownTypes["ЗаписьXML"] = new BslTypeInfo
            {
                Name = "ЗаписьXML",
                Members = new()
                {
            ...
            KnownTypes["Файл"] = new BslTypeInfo
            {
                Name = "Файл",
                Members = new()
                {
            ...
            KnownTypes["РегулярноеВыражение"] = new BslTypeInfo
            {
                Name = "РегулярноеВыражение",
                Members = new()
                {
            ...
            KnownTypes["XDTOСхема"] = new BslTypeInfo
            {
                Name = "XDTOСхема",
                Members = new()
                {
            ...
            KnownTypes["XDTOПакет"] = new BslTypeInfo
            {
                Name = "XDTOПакет",
                Members = new()
                {
            ...
            KnownTypes["HTTPСоединение"] = new BslTypeInfo
            {
                Name = "HTTPСоединение",
                Members = new()
                {
